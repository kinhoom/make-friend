...
class table_tom_love_gift_count extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_love_gift_count';
		$this->_pk    = 'id';
	}
    ...
    public function fetch_gift_count($condition) {
        $return = DB::fetch_first("SELECT SUM(gift_num) as num FROM ".DB::table($this->_table)." WHERE 1 $condition ");
		return $return['num'];
	}
