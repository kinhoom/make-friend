...
echo '<script src="source/plugin/tom_xiangqin/images/admin.js"></script>';
echo '<link rel="stylesheet" type="text/css" href="source/plugin/tom_xiangqin/images/admin.css"/>';

function get_xiangqin_config($pluginid){
