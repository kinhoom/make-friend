...
class table_tom_xiangqin_chakan extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_xiangqin_chakan';
		$this->_pk    = 'id';
	}
    ...
    public function fetch_by_user_xiangqin_id($user_id,$xiangqin_id) {
		return DB::fetch_first("SELECT * FROM %t WHERE user_id=%d AND xiangqin_id=%d ", array($this->_table, $user_id,$xiangqin_id));
	}
    ...
    public function delete_by_xiangqin_id($uid) {
		return DB::query("DELETE FROM %t WHERE xiangqin_id=%d", array($this->_table, $uid));
	}
